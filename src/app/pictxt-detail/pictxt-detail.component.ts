...
import { Content , Pictxt , Data } from '../exhibition/type';
...
@Component({
  selector: 'app-pictxt-detail',
  templateUrl: './pictxt-detail.component.html',
  styleUrls: ['./pictxt-detail.component.css']
})
export class PictxtDetailComponent implements OnInit {
  post: string;
  excontent: any[];
  excontent2: any[];
  ptitle: string;
